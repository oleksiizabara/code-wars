...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { date: @mark.date, for_pupil_id: @mark.for_pupil_id, subj: @mark.subj, value: @mark.value } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { date: @mark.date, for_pupil_id: @mark.for_pupil_id, subj: @mark.subj, value: @mark.value } }
