...
class PupilsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pupil" do
    assert_difference('Pupil.count') do
      post pupils_url, params: { pupil: { login: @pupil.login, name: @pupil.name, password: @pupil.password } }
    end
  ...
  test "should update pupil" do
    patch pupil_url(@pupil), params: { pupil: { login: @pupil.login, name: @pupil.name, password: @pupil.password } }
